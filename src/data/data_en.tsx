...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    description:
      'Developed customer management, fitting history, authentication, and search features using PHP (Laravel) and MySQL while collaborating with an international development team.',
    url: '#',
  ...
  },
  {
    ...
    description:
      'Developed a full-stack e-commerce platform using Laravel, Next.js, and MySQL, featuring authentication, RBAC, content management, and a loyalty & rewards system with well-defined business logic.',
    url: '#',
  ...
  },
  {
    title: 'Nishispo-CMS',
    description:
      'Developed core CMS features using PHP, jQuery, and MySQL, including photo uploads, AJAX forms, CSV export.',
    url: '#',
  ...
  },
  {
    ...
    description:
      'Built employee scheduling, time tracking, task assignment, and reporting using PHP, and Bootstrap, with a focus on security.',
    url: '#',
  ...
  },
  {
    title: 'Hokkaido-CMS',
    description:
      'Built CMS features like advertisement management, media upload, and editor tools using PHP, jQuery, and MySQL.',
    url: '#',
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        My academic background provided me with hands-on experience in scientific research and laboratory work. For my
        master's thesis, I studied the toxicology of naturally occurring mercury in fish, strengthening my analytical
  ...
  },
  {
    ...
    content: (
      <p>
        Built a strong foundation in web development through hands-on projects using Java, HTML, CSS, JavaScript, and
        SQL. Also explored Python and introductory AI concepts while strengthening problem-solving and software
        development skills.
      </p>
    ),
  },
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Primarily working with PHP (Laravel) to build and maintain scalable web applications. Collaborating with senior
        developers and international team members to develop new features, resolve issues, and continuously improve
